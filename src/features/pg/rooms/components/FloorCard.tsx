...
export function FloorCard({
    ...
    return (
        <div className="flex flex-col justify-between rounded-2xl border border-neutral-100 bg-white p-3.5 sm:p-4 shadow-2xs transition-all hover:border-neutral-200 hover:shadow-xs space-y-3.5">
            ...
            {/* Room Count Stat Box */}
            <div className="flex items-center justify-between rounded-xl border border-neutral-100/80 bg-neutral-50/80 px-3 py-2">
...
export function FloorCardSkeleton() {
    return (
        <div className="flex flex-col justify-between rounded-2xl border border-neutral-100 bg-white p-3.5 sm:p-4 shadow-2xs space-y-3.5 animate-pulse">
            {/* Top row: Floor info & Icon */}
            <div className="flex items-start justify-between gap-3">
                <div className="min-w-0 flex-1 space-y-1.5">
                    ...
                    {/* Floor name skeleton */}
                    <div className="mt-1 h-5 w-32 rounded-md bg-neutral-200" />
                </div>
