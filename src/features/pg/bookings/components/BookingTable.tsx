...
export function BookingTable({ bookings, onDelete }: BookingTableProps) {
    ...
    return (
        <div className="overflow-hidden rounded-2xl border border-neutral-100 bg-white shadow-2xs">
...
export function BookingTableSkeleton() {
    return (
        <div className="overflow-hidden rounded-2xl border border-neutral-100 bg-white shadow-2xs animate-pulse">
            <div className="overflow-x-auto">
